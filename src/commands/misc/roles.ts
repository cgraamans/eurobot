...
module.exports = {
	...
	async execute(interaction:CommandInteraction) {
		...
		let embed = new EmbedBuilder()
			...
			.setDescription(`Below you will find the list of available roles and commands for Eurobot and Forum Gotterfunken. By being here and accessing these roles and commands you agree to adhere to our rules and follow the instructions of the moderators. For more information see #introduction.
